(() => {
  ...
  function addCard() {
    ...
    card.setAttribute("aria-label", "Prøv Erling FPS gratis i fire minutter uden login");
    card.innerHTML = `
      <div class="fps-trial-entry-copy">
        <span class="fps-trial-entry-kicker">PRØV UDEN LOGIN</span>
        <h3>ERLING FPS</h3>
        <p>Regn. Tjen blyanter. Overlev skolen. Du får 4 minutters prøvespil.</p>
      ...
      <div class="fps-trial-entry-scene" aria-hidden="true">
        ...
        <span class="fps-trial-entry-burst">4 MIN<br>GRATIS</span>
      </div>`;
