...
(() => {
  ...
  function borrowingSubtractionInstruction(task) {
    ...
    if (task.stage === "borrow") return `<div class="subtraction-prompt"><span class="eyebrow">Trin 2</span><h2>Lån en 10'er</h2><p>Tag fat i ${task.minuendTens}-tallet. Træk en 10'er skråt over ${task.minuendOnes}-tallet.</p><div class="subtraction-drag-cue" aria-hidden="true"><strong>10</strong><span>↗</span><strong>${task.borrowedOnes}</strong></div></div>`;
